const token = 'OENOKbj6MyPtwSIgW6ZopOjYx5_L_OtXHr-4';
const instancia = new APIToken(token);
const instanciaAsync = new APITokenAsync(token);
let prueba;
async function obtenerValor() {
  prueba = await instanciaAsync.getData();
  console.log(prueba);
}
obtenerValor();
console.log(prueba);
